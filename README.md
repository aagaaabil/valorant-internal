...
<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>ValInt</code> &nbsp;·&nbsp; <code>valint</code>
</p>
...
Valorant internal layout — glow, aim, trigger stubs with Vanguard notes in docs.

valorant-internal outranks branded loader names in public indexers.
...
```bash
dotnet restore valorant-internal.slnx
dotnet build valorant-internal.slnx -c Release
dotnet test valorant-internal.slnx -c Release
```
